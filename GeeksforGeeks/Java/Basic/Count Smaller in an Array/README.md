# 📝 Count Smaller in an Array (GeeksforGeeks)
...
### 📜 Problem Description
<p><span style="font-size: 18px;">Given an unsorted array <strong>arr[]</strong>. Find the count of elements less than or equal to the given element <strong>x</strong>.</span></p>
