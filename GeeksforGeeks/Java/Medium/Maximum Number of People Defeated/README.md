# 📝 Maximum Number of People Defeated (GeeksforGeeks)
...
### 📜 Problem Description
<p><span style="font-size: 18px;">There are infinitely<strong> </strong>many people standing in a row, indexed from 1. The strength<strong> </strong>of the person at index <strong>i</strong> is <strong>i²</strong>.</span></p>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ p ≤ 3*10<sup>8</sup></span></p>